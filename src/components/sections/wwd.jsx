  ...
  return (
    <div className="mx-auto p-8 py-16 lg:py-24 bg-gradient-to-br from-gray-50 to-gray-100 mb-10">
      ...
      <div className="text-center">
        <Link to="/services" className="inline-flex items-center gap-3 bg-gradient-to-r from-gray-900 to-gray-800 text-white px-10 py-4 rounded-xl font-semibold hover:from-gray-800 hover:to-gray-700 transition-all duration-300 hover:shadow-xl hover:shadow-gray-300/30 transform hover:-translate-y-1">
          View All Services
